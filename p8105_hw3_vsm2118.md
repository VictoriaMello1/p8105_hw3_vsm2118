...
plot_combined <- ggplot(ny_data, aes(x = response, y = data_value, color = locationdesc, size = data_value)) +
...
Bronx, Erie, and Monroe counties. \#### Finish comment with which NY
counties had highest vs lowest general health in each year
